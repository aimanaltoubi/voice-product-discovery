...
- comparison_criteria: 3-5 criteria to weigh the candidates against, derived from the user's constraints (e.g. price, features, ingredients, eco-friendliness, value per ounce).
